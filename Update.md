...
Şimdi bizim Basic-coin-prediction-node dizinine girmemiz lazım 
--
 Rues'in repoda cd komutu ile ana dizine dönmeden Allora dizini içerisinde kurmuşsundur vb. ihtimaller  için 2 tarafıda ekledik.
--
